#!/usr/bin/env python3
"""Extract Swin through stage-2 (stages 0-2, 22 blocks + 2 downsamples + patch_embed)."""
...
PREFIXES = ("bb_patch_embed_",) + tuple(STAGE_PREFIXES)
...
def main():
    ...
    writer.add_string("rmbg.subset", "swin_stage2")
    n = 0
