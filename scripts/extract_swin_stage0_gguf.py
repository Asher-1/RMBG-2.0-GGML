#!/usr/bin/env python3
"""Extract Swin stage-0 (blocks 0+1) + patch_embed weights into a small GGUF."""
...
PREFIXES = ("bb_patch_embed_", "bb_layers_0_blocks_0_", "bb_layers_0_blocks_1_")
...
def main():
    ...
    writer.add_string("rmbg.subset", "swin_stage0")
    n = 0
